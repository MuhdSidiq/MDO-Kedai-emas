...
<head>
    ...
    <title>Add New Product - Kedai Emas</title>
                    ...
                    <div class="card-body">
                        ...
                        <form action="/products/store" method="POST">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number"
                                               ...
                                               min="0"
                                               placeholder="0.00"
                                               value="<?= htmlspecialchars($_POST['price_per_gram'] ?? '') ?>"
                                               required>
                                    </div>
                            ...
                            <div class="alert alert-info">
                                <i class="bi bi-info-circle"></i> <strong>Note:</strong> All fields marked with <span class="text-danger">*</span> are required.
                            </div>
